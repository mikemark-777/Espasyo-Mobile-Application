...
public class StudentShowAllRoomsActivity extends AppCompatActivity implements RoomAdapter.OnRoomListener {
    ...
    public void initRoomRecyclerView() {
        ...
        LinearLayoutManager roomLayoutManager = new LinearLayoutManager(StudentShowAllRoomsActivity.this, LinearLayoutManager.VERTICAL, false);
        showAllRoomRecyclerView.setLayoutManager(roomLayoutManager);
        roomAdapter = new RoomAdapter(StudentShowAllRoomsActivity.this, allRooms, this);
    ...
    public void onRoomClick(int position) {
        Intent intent = new Intent(StudentShowAllRoomsActivity.this, RoomDetailsActivity.class);
