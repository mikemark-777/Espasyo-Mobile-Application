...
public class PropertyRecyclerView  extends RecyclerView {
    ...
    public PropertyRecyclerView(@NonNull Context context) {
        super(context);
    }

    public PropertyRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public PropertyRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
